...
Description: This can be used to download the stock price data usign yfinance api in csv file.
"""
...
def main():
    ...
    parser.add_argument("--tickers", nargs="+", required=True, help="List of stock tickers (ex: AAPL")
